			...
			<ul class="navbar-nav my-2 my-lg-0">
                <li class="nav-item">
                    <div class="btn btn-group text-reset">
                        <a class="nav-link  text-reset" href="alt-del.php"><img src="assets/images/voltar.png"> Voltar</a>
...
<!-- Formulário para edição de links -->
    ...
    <div class="container"><br/><br/><br/><br/><br/>
		...
		<div class="col">
            ...
            <h2 class="text-center bg-primary">Editar Link</h2><br/>
            <div class="form-group">
					...
					<input type="submit"  class="btn btn-primary btn-lg btn-block" value="Editar Link">
            </form>
            </div>
        <div class="col-3"></div>    
    </div>
